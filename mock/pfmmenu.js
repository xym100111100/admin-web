...
menuData.push({ id: '1536131597142', sysId: 'damai-admin', code: '0301', title: '退货管理', name: '退货管理', path: 'ord-return', isEnabled: true, icon: null, remark: '退货管理' });
...
menuData.push({ id: '1536131597146', sysId: 'damai-admin', code: '1403', title: '账号充值', name: '账号交易流水', path: 'afc-flow-mng', isEnabled: true, icon: null, remark: '账号交易流水相关业务' });
